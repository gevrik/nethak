...
void boot_db( void )
{
	...
	log_string("Assigning gsn's");
        ...
        ASSIGN_GSN( gsn_survey , "analyze" );
        ASSIGN_GSN( gsn_landscape , "modify" );
        ASSIGN_GSN( gsn_construction , "construct" );
        ASSIGN_GSN( gsn_quicktalk , "quicktalk" );
        ASSIGN_GSN( gsn_bridge , "bridge" );
        ASSIGN_GSN( gsn_propaganda , "propaganda" );
        ASSIGN_GSN( gsn_hijack  , "hijack" );
        ASSIGN_GSN( gsn_makejewelry  , "codeutil" );
        ASSIGN_GSN( gsn_makeblade  , "codeblade" );
        ...
        ASSIGN_GSN( gsn_spacecraft,    "decking" );
	...
	ASSIGN_GSN( gsn_vibro_blades,	"blades" );
	...
	ASSIGN_GSN( gsn_poison_weapon, 	"poisonmod" );
	...
	ASSIGN_GSN( gsn_dual_wield,	"dualwield" );
...
MOB_INDEX_DATA *make_mobile( long vnum, long cvnum, char *name )
{
	...
	if ( !cMobIndex )
	{
	  ...
	  sprintf( buf, "> some AI abandoned a newly created %s here.\n\r", name );
