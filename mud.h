...
#define MAX_PLANET_CLAN		  5
#define MAX_PLANET_SYSTEM	 5
...
#define SPACE_SHOW	  0
#define SPACE_HIDDEN	 -1
#define PLANET_OPEN	  0
#define PLANET_CLOSED	 -1
...
#define ACT_IS_SURGEON           BV28 /* A surgeon mob */
...
typedef enum
{
  ...
  SECT_MAX,SECT_STACK,SECT_HOST,SECT_SERVER,SECT_HYPERLINK,SECT_LINK,
  SECT_WIKI,SECT_404,SECT_WEBBROWSER,SECT_COOKIE,SECT_CHATROOM, SECT_FORUM,
  SECT_TORRENT, SECT_NEXUS, SECT_PROXY, SECT_INDEX, SECT_BROKENPORT
} sector_types;
...
#define IS_IMMORTAL(ch)		(!str_cmp((ch)->name,"Wintermute"))
...
#define GET_MAX_STR(CH) ( IS_NPC((ch)) ? 20 : ( 25 + \
                ( IS_SET((ch)->pcdata->cyber, CYBER_STRENGTH) ? 1 : 0 ) ) )
#define GET_MAX_DEX(CH) ( IS_NPC((ch)) ? 20 : ( 25 + \
                ( IS_SET((ch)->pcdata->cyber, CYBER_REFLEXES) ? 1 : 0 ) ) )
#define GET_MAX_INT(CH) ( IS_NPC((ch)) ? 20 : ( 25 + \
                ( IS_SET((ch)->pcdata->cyber, CYBER_MIND) ? 1 : 0 ) ) )
#define GET_MAX_WIS(CH) ( IS_NPC((ch)) ? 20 : ( 25 ) )
#define GET_MAX_CON(CH) ( IS_NPC((ch)) ? 20 : ( 25 ) )
#define GET_MAX_CHA(CH) ( IS_NPC((ch)) ? 20 : ( 25 ) )
#define GET_MAX_LCK(CH) ( IS_NPC((ch)) ? 20 : ( 25 ) )
...
ED *	get_exit_to	args( ( ROOM_INDEX_DATA *room, sh_int dir, long vnum ) );
...
PLANET_DATA * get_planet_here	    args( ( char *name , SPACE_DATA *starsystem ) );
...
void	log_string_plus	args( ( const char *str, sh_int log_type ) );
...
bool    char_from_ship  args( ( CHAR_DATA *ch, SHIP_DATA *ship ) );
bool	char_to_ship	args( ( CHAR_DATA *ch, SHIP_DATA *ship ) );
